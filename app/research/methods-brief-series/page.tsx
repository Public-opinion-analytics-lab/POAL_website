            ...
            <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-8 max-w-md mx-auto mb-8">
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-xs font-medium mb-2">By Dr. Victor Araújo and Dr. Miriam Sorace</p>
                  <p className="text-gray-600 text-sm mb-4">
                    This brief introduces the Unexpected Event during Survey Design (UESD) approach.
                  </p>
